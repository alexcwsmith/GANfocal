...
psnr, ssim = gfm.train(modelName, img_zdepth, img_width, img_height, kernel=kernel, img_path=img_path, 
          ...
          residual_blocks=residual_blocks, feature_size=feature_size, subpixel_NN=True, nn=False, restore=restore, 
          batch_size=batch_size, epochs=epochs, saveiters=saveiters, train_fraction=train_fraction)

    
gfm.evaluate(modelName, kernel, img_zdepth, img_height, img_width, img_path, checkpoint_dir, result_dir,
